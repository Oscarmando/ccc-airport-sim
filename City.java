...
public class City implements Actor
{
    ...
    private static final double IN_BOUND_FLIGHT_PROBABILITY = .2;
    private static final double GROUNDED_FLIGHT_PROBABILITY = .6;
    ...
    private void makeInBoundFlight(){
        Flight f = new Flight(this, gui, rgen.nextInt(9999), rgen.nextInt(15) + 1, rgen.nextInt(350) + 11, false);
        actors.add(f);
        st.newFlight(f);
        inbound.add(f);
    }
    ...
    private void makeGroundedFlight(){
        Flight f = new Flight(this, gui, rgen.nextInt(9999), rgen.nextInt(15) + 1, rgen.nextInt(360) + 1, true);
        actors.add(f);
        st.newFlight(f);
        grounded.add(f);
    }
